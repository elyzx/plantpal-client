                    ...
                    <div className='flex-box'>
                        <form onSubmit={onEdit}>
                            ...
                            <div style={space} className="form-group">
                                ...
                                <input style={space} type="text" className="form-control" id="InputPostal" onChange={handleChangeDetails} value={profileDetails.postal} name="postal" placeholder="change your postal code" />
                            </div>
